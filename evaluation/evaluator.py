...
class Evaluator(object):
    ...
    # This is used to measure inference throughput (FPS).
    ...
    def evaluate_video(self, model, video_name, video_parts, output_path):
        for vos_data in video_parts:
            ...
            # `files` is a list like ['00000.png', ...] used to name output masks.
    ...
    def evaluate(self, model, output_path):
        ...
        # `get_videos()` is implemented by the dataset (e.g., DAVIS) and yields iterable video snippets.
