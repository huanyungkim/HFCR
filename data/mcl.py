...
class TestMCL(torch.utils.data.Dataset):
    def __init__(self, root):
        self.root = root
        self.video_list = sorted(os.listdir(os.path.join(root, 'PNGImages')))
    ...
    def __getitem__(self, idx):
        ...
        img_dir = os.path.join(self.root, 'PNGImages', video_name)
        flow_dir = os.path.join(self.root, 'PNGFlows', video_name)
